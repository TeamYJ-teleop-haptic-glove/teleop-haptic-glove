...
# Assuming your Leap URDF has the following tip link names
LEAP_TIP_LINKS = {
    "thumb":  "thumb_fingertip",  # Modify this if the name is different in the URDF
    "index":  "index_fingertip",  # Modify this if the name is different in the URDF
    "middle": "middle_fingertip", # Modify this if the name is different in the URDF
    "ring":   "ring_fingertip",   # Modify this if the name is different in the URDF
}

# Ensure that these names are consistent with the URDF structure
...
if __name__ == "__main__":
    ...
    LEAP_URDF  = "LEAP_Hand_Sim/assets/leap_left_urdf/robot.urdf"
